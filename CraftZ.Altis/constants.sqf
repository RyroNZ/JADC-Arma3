...
GUI_BLOOD_BORDER_HEALTHY_COLOR = [0.5,1,0.92,1];
...
TEMPERATURE_MAX_WATER_TEMP_VARIATION = 10;
TEMPERATURE_OVERCAST_EFFECT_ON_TEMP = 8;
TEMPERATURE_RAIN_EFFECT_ON_TEMP = 15;
...
SERVER_EXEC_LOOT_DESPAWNER = "server\core\lootSpawner\lootDespawner.sqf";
...
DB_CATAGORY_SAVED_OBJECTS = "currentObjects";

DB_SUB_CATAGORY_VEHICLES = "currentVehicles";
DB_SUB_CATAGORY_TENTS = "currentTents";
...
LOOT_SPAWN_CHANCE = 30;	// SPAWN DIFFICULTY 0-100 (100 always spawns, 0 never spawns).. 
